...
namespace SimpleWebAPI.Domain.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthModelResponse Authenticate(AuthModelRequest model, string ipAddress)
        {
            var user = _mapper.Map<AuthModel>(model);
            ...
            return _mapper.Map<AuthModelResponse>(user);
        }

        public AuthModelResponse RefreshToken(string token, string ipAddress)
        {
            ...
            return new AuthModelResponse();
                //new UserModel(user, jwtToken, newRefreshToken.Token);
        }
